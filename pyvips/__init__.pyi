...
class Image:
    ...
    def set_type(
        ...
        gtype: int,
        name: str,
        value: Union[bool, int, float, str, Image, list[int], list[float], list[Image]],
    ) -> None: ...
    def set(
        self,
        name: str,
    ...
    @staticmethod
    def new_from_buffer(
        data: Union[bytes, bytearray, memoryview], options: str, **kwargs: object
    ) -> Image: ...
    @staticmethod
    def new_from_list(
    ...
    def new_from_array(
        cls,
        obj: Union[List, bytes, bytearray, memoryview],
        scale: float = 1.0,
        offset: float = 0.0,
        interpretation: Optional[Union[str, Interpretation]] = None,
    ) -> Image: ...
    @staticmethod
    def new_from_memory(
    ...
    def write_to_target(
        self, target: Target, format_string: str, **kwargs: object
    ) -> None: ...
    ...
    def __array__(
        self, dtype: Optional[str] = None, copy: Optional[bool] = None
    ) -> object: ...
    ...
    def bandjoin(
        self, other: Union[Image, float, int, List[Union[Image, float, int]]]
    ) -> Image: ...
    def bandrank(self, other: Union[Image, List[Image]], **kwargs: object) -> Image: ...
    def composite(
        self,
        other: Union[Image, List[Image]],
        mode: Union[str, BlendMode, List[Union[str, BlendMode]]],
        **kwargs: object,
    ) -> Image: ...
    ...
    def ifthenelse(
        self,
        in1: Union[Image, float, int, List[float], List[int]],
        in2: Union[Image, float, int, List[float], List[int]],
        **kwargs: object,
    ) -> Image: ...
    ...
    def arrayjoin(
        ...
        shim: int = ...,
        background: list[float] = ...,
        halign: Union[str, Align] = ...,
        valign: Union[str, Align] = ...,
        hspacing: int = ...,
        vspacing: int = ...,
    ) -> Image: ...
    def autorot(
        self, angle: bool = ..., flip: bool = ...
    ) -> Union[
        Image,
        tuple[
            Image,
    ...
    def boolean_const(
        self, boolean: Union[str, OperationBoolean], c: list[float]
    ) -> Image: ...
    def buildlut(self) -> Image: ...
    def byteswap(self) -> Image: ...
    def cache(
        self, max_tiles: int = ..., tile_height: int = ..., tile_width: int = ...
    ) -> Image: ...
    def canny(
        self, sigma: float = ..., precision: Union[str, Precision] = ...
    ) -> Image: ...
    ...
    def colourspace(
        self,
        space: Union[str, Interpretation],
        source_space: Union[str, Interpretation] = ...,
    ) -> Image: ...
    def compass(
        self,
        mask: Image,
        times: int = ...,
        angle: Union[str, Angle45] = ...,
        combine: Union[str, Combine] = ...,
    ...
    def composite2(
        ...
        x: int = ...,
        y: int = ...,
        compositing_space: Union[str, Interpretation] = ...,
        premultiplied: bool = ...,
    ) -> Image: ...
    def conv(
        self,
    ...
    def draw_circle(
        self, ink: list[float], cx: int, cy: int, radius: int, fill: bool = ...
    ) -> Image: ...
    def draw_flood(
        self,
        ink: list[float],
    ...
    def draw_image(
        self, sub: Image, x: int, y: int, mode: Union[str, CombineMode] = ...
    ) -> Image: ...
    def draw_line(
        self, ink: list[float], x1: int, y1: int, x2: int, y2: int
    ) -> Image: ...
    ...
    @staticmethod
    def eye(
        width: int, height: int, uchar: bool = ..., factor: float = ...
    ) -> Image: ...
    ...
    def flatten(
        self, background: list[float] = ..., max_alpha: float = ...
    ) -> Image: ...
    ...
    def gravity(
        self,
        direction: Union[str, CompassDirection],
        width: int,
        height: int,
        extend: Union[str, Extend] = ...,
        background: list[float] = ...,
    ...
    def hist_find_indexed(
        self, index: Image, combine: Union[str, Combine] = ...
    ) -> Image: ...
    ...
    def hough_circle(
        self, scale: int = ..., min_radius: int = ..., max_radius: int = ...
    ) -> Image: ...
    ...
    def math2_const(
        self, math2: Union[str, OperationMath2], c: list[float]
    ) -> Image: ...
    @staticmethod
    def matload(
        filename: str,
    ...
    def rawload(
        ...
        offset: int = ...,
        format: Union[str, BandFormat] = ...,
        interpretation: Union[str, Interpretation] = ...,
        memory: bool = ...,
        access: Union[str, Access] = ...,
        fail_on: Union[str, FailOn] = ...,
        revalidate: bool = ...,
    ...
    def reduceh(
        self, hshrink: float, kernel: Union[str, Kernel] = ..., gap: float = ...
    ) -> Image: ...
    def reducev(
        self, vshrink: float, kernel: Union[str, Kernel] = ..., gap: float = ...
    ) -> Image: ...
    def relational(
        self, right: Image, relational: Union[str, OperationRelational]
    ) -> Image: ...
    def relational_const(
        self, relational: Union[str, OperationRelational], c: list[float]
    ) -> Image: ...
    ...
    def smartcrop(
        ...
        width: int,
        height: int,
        interesting: Union[str, Interesting] = ...,
        premultiplied: bool = ...,
        attention_x: bool = ...,
        attention_y: bool = ...,
    ) -> Union[
    ...
    @staticmethod
    def worley(
        width: int, height: int, cell_size: int = ..., seed: int = ...
    ) -> Image: ...
    def wrap(self, x: int = ..., y: int = ...) -> Image: ...
    @staticmethod
    def xyz(
        width: int, height: int, csize: int = ..., dsize: int = ..., esize: int = ...
    ) -> Image: ...
    @staticmethod
    ...
    # Operator overloads
    def __add__(
        self, other: Union[Image, float, int, List[float], List[int]]
    ) -> Image: ...
    ...
    def __rtruediv__(
        self, other: Union[float, int, List[float], List[int]]
    ) -> Image: ...
    def __floordiv__(
        self, other: Union[Image, float, int, List[float], List[int]]
    ) -> Image: ...
