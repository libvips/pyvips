...
class Image:
    ...
    def copy(self, width: int = ..., height: int = ..., bands: int = ..., format: Union[str, BandFormat] = ..., coding: Union[str, Coding] = ..., interpretation: Union[str, Interpretation] = ..., xres: float = ..., yres: float = ..., xoffset: int = ..., yoffset: int = ...) -> Image: ...
