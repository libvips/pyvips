...
.. class:: pyvips.Image
   ...
   .. staticmethod:: bandrank(in, index = int)
      ...
      :param list[Image] in: Array of input images
      :param int index: Select this band element from sorted list
      :rtype: Image
      :raises Error:
   ...
   .. method:: ifthenelse(in1, in2, blend = bool)
      ...
      :param Image in1: Source for TRUE pixels
      :param Image in2: Source for FALSE pixels
      :param bool blend: Blend smoothly between then and else parts
      :rtype: Image
      :raises Error:
   ...
   .. method:: max(size = int)
      ...
      :rtype: list[float, int, int, list[float], list[int], list[int]]
      :raises Error:
   ...
   .. method:: mosaic(sec, direction, xref, yref, xsec, ysec, hwindow = int, harea = int, mblend = int, bandno = int)
      ...
      :rtype: list[Image, int, int, float, float, float, float]
      :raises Error:
   ...
   .. method:: scale(exp = float, log = bool)
      ...
      :param float exp: Exponent for log scale
      :param bool log: Log scale
      :rtype: Image
      :raises Error:
