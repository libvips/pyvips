...
.. class:: pyvips.Image
   ...
   .. method:: affine(matrix, interpolate=GObject, oarea=list[int], odx=float, ody=float, idx=float, idy=float, background=list[float], premultiplied=bool, extend=str)
      
      Affine transform of an image.
      
      Example:
          out = in.affine(matrix, interpolate=GObject, oarea=list[int], odx=float, ody=float, idx=float, idy=float, background=list[float], premultiplied=bool, extend=str)
      ...
      :param bool premultiplied: Images have premultiplied alpha
      :param str extend: How to generate the extra pixels
      :rtype: Image
      :raises Error:
      
   .. staticmethod:: analyzeload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load an Analyze6 image.
      
      Example:
          out = pyvips.Image.analyzeload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: autorot(angle=bool, flip=bool)
      ...
      :param bool angle: enable output: Angle image was rotated by
      :param bool flip: enable output: Whether the image was flipped or not
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
   ...
   .. method:: canny(sigma=float, precision=str)
   ...
   .. method:: case(cases)
      ...
      :param list[Image] cases: Array of case images
      :rtype: Image
      :raises Error:
   ...
   .. staticmethod:: composite(in, mode, x=list[int], y=list[int], compositing_space=str, premultiplied=bool)
      ...
      :param list[Image] in: Array of input images
      :param list[int] mode: Array of VipsBlendMode to join with
      :param list[int] x: Array of x coordinates to join at
      :param list[int] y: Array of y coordinates to join at
      :param str compositing_space: Composite images in this colour space
      :param bool premultiplied: Images have premultiplied alpha
      :rtype: Image
      :raises Error:
      
   .. method:: composite2(overlay, mode, x=int, y=int, compositing_space=str, premultiplied=bool)
      ...
      :param Image overlay: Overlay image
      :param str mode: VipsBlendMode to join with
      :param int x: x position of overlay
      :param int y: y position of overlay
      :param str compositing_space: Composite images in this colour space
      :param bool premultiplied: Images have premultiplied alpha
      :rtype: Image
      :raises Error:
   ...
   .. method:: copy(swap=bool, width=int, height=int, bands=int, format=str, coding=str, interpretation=str, xres=float, yres=float, xoffset=int, yoffset=int)
      
      Copy an image.
      
      Example:
          out = in.copy(swap=bool, width=int, height=int, bands=int, format=str, coding=str, interpretation=str, xres=float, yres=float, xoffset=int, yoffset=int)
      
      :param bool swap: Swap bytes in image between little and big-endian
      :param int width: Image width in pixels
      :param int height: Image height in pixels
      :param int bands: Number of bands in image
   ...
   .. staticmethod:: csvload(filename, skip=int, lines=int, whitespace=str, separator=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load csv.
      
      Example:
          out = pyvips.Image.csvload(filename, skip=int, lines=int, whitespace=str, separator=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: csvload_source(source, skip=int, lines=int, whitespace=str, separator=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load csv.
      
      Example:
          out = pyvips.Image.csvload_source(source, skip=int, lines=int, whitespace=str, separator=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: draw_flood(ink, x, y, test=Image, equal=bool, left=bool, top=bool, width=bool, height=bool)
      ...
      :param bool left: enable output: Left edge of modified area
      :param bool top: enable output: top edge of modified area
      :param bool width: enable output: width of modified area
      :param bool height: enable output: height of modified area
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
   ...
   .. method:: fill_nearest(distance=bool)
      ...
      :param bool distance: enable output: Distance to nearest non-zero pixel
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
   ...
   .. method:: find_trim(threshold=float, background=list[float])
      ...
      :param float threshold: Object threshold
      :param list[float] background: Color for background pixels
      :rtype: list[int, int, int, int]
      :raises Error:
      
   .. staticmethod:: fitsload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a FITS image.
      
      Example:
          out = pyvips.Image.fitsload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: gaussmat(sigma, min_ampl, separable=bool, integer=bool, precision=str)
      
      Make a gaussian image.
      
      Example:
          out = pyvips.Image.gaussmat(sigma, min_ampl, separable=bool, integer=bool, precision=str)
      
      :param float sigma: Sigma of Gaussian
      :param float min_ampl: Minimum amplitude of Gaussian
      :param bool separable: Generate separable Gaussian
      :param bool integer: Generate integer Gaussian
   ...
   .. staticmethod:: gifload(filename, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load GIF with giflib.
      
      Example:
          out = pyvips.Image.gifload(filename, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: gifload_buffer(buffer, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load GIF with giflib.
      
      Example:
          out = pyvips.Image.gifload_buffer(buffer, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: gravity(direction, width, height, extend=str, background=list[float])
      ...
      :param str direction: direction to place image within width/height
      :param int width: Image width in pixels
      :param int height: Image height in pixels
      :param str extend: How to generate the extra pixels
      :param list[float] background: Color for background pixels
   ...
   .. staticmethod:: heifload(filename, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a HEIF image.
      
      Example:
          out = pyvips.Image.heifload(filename, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param int page: Load this page from the file
      :param int n: Load this many pages
      :param bool thumbnail: Fetch thumbnail image
   ...
   .. staticmethod:: heifload_buffer(buffer, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a HEIF image.
      
      Example:
          out = pyvips.Image.heifload_buffer(buffer, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: heifload_source(source, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a HEIF image.
      
      Example:
          out = pyvips.Image.heifload_source(source, page=int, n=int, thumbnail=bool, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: hist_find_indexed(index, combine=str)
      ...
      :param str combine: Combine bins like this
      :rtype: Image
      :raises Error:
   ...
   .. staticmethod:: jpegload(filename, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load jpeg from file.
      
      Example:
          out = pyvips.Image.jpegload(filename, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: jpegload_buffer(buffer, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load jpeg from buffer.
      
      Example:
          out = pyvips.Image.jpegload_buffer(buffer, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: jpegload_source(source, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load image from jpeg source.
      
      Example:
          out = pyvips.Image.jpegload_source(source, shrink=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: jpegsave(filename, Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
      
      Save image to jpeg file.
      
      Example:
           = in.jpegsave(filename, Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
      ...
      :param bool optimize_scans: Split spectrum of DCT coefficients into separate scans
      :param int quant_table: Use predefined quantization table with given index
      :param str subsample_mode: Select chroma subsample operation mode
      :param bool strip: Strip all metadata from image
      :param list[float] background: Background value
      :param int page_height: Set page height for multipage save
      :rtype: list[]
   ...
   .. method:: jpegsave_buffer(Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
      
      Save image to jpeg buffer.
      
      Example:
          buffer = in.jpegsave_buffer(Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
   ...
   .. method:: jpegsave_mime(Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
      
      Save image to jpeg mime.
      
      Example:
           = in.jpegsave_mime(Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
   ...
   .. method:: jpegsave_target(target, Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
      
      Save image to jpeg target.
      
      Example:
           = in.jpegsave_target(target, Q=int, profile=str, optimize_coding=bool, interlace=bool, no_subsample=bool, trellis_quant=bool, overshoot_deringing=bool, optimize_scans=bool, quant_table=int, subsample_mode=str, strip=bool, background=list[float], page_height=int)
   ...
   .. method:: labelregions(segments=bool)
      ...
      :param bool segments: enable output: Number of discrete contigious regions
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
   ...
   .. staticmethod:: logmat(sigma, min_ampl, separable=bool, integer=bool, precision=str)
      
      Make a laplacian of gaussian image.
      
      Example:
          out = pyvips.Image.logmat(sigma, min_ampl, separable=bool, integer=bool, precision=str)
      ...
      :param bool integer: Generate integer Logmatian
      :param str precision: Generate with this precision
      :rtype: Image
      :raises Error:
      
   .. staticmethod:: magickload(filename, all_frames=bool, density=str, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load file with ImageMagick.
      
      Example:
          out = pyvips.Image.magickload(filename, all_frames=bool, density=str, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param bool all_frames: Read all frames from an image
   ...
   .. staticmethod:: magickload_buffer(buffer, all_frames=bool, density=str, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load buffer with ImageMagick.
      
      Example:
          out = pyvips.Image.magickload_buffer(buffer, all_frames=bool, density=str, page=int, n=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: magicksave(filename, format=str, quality=int, optimize_gif_frames=bool, optimize_gif_transparency=bool, strip=bool, background=list[float], page_height=int)
      ...
      :param str filename: Filename to save to
      :param str format: Format to save in
      :param int quality: Quality to use
      :param bool optimize_gif_frames: Apply GIF frames optimization
      :param bool optimize_gif_transparency: Apply GIF transparency optimization
      :param bool strip: Strip all metadata from image
      :param list[float] background: Background value
      :param int page_height: Set page height for multipage save
      :rtype: list[]
   ...
   .. staticmethod:: matload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load mat from file.
      
      Example:
          out = pyvips.Image.matload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: matrixload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load matrix.
      
      Example:
          out = pyvips.Image.matrixload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: matrixload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load matrix.
      
      Example:
          out = pyvips.Image.matrixload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: max(size=int, x=bool, y=bool, out_array=bool, x_array=bool, y_array=bool)
      ...
      :param bool x: enable output: Horizontal position of maximum
      :param bool y: enable output: Vertical position of maximum
      :param bool out_array: enable output: Array of output values
      :param bool x_array: enable output: Array of horizontal positions
      :param bool y_array: enable output: Array of vertical positions
   ...
   .. method:: min(size=int, x=bool, y=bool, out_array=bool, x_array=bool, y_array=bool)
      ...
      :param bool x: enable output: Horizontal position of minimum
      :param bool y: enable output: Vertical position of minimum
      :param bool out_array: enable output: Array of output values
      :param bool x_array: enable output: Array of horizontal positions
      :param bool y_array: enable output: Array of vertical positions
      :rtype: float or list[float, Dict[str, mixed]]
   ...
   .. method:: mosaic(sec, direction, xref, yref, xsec, ysec, hwindow=int, harea=int, mblend=int, bandno=int, dx0=bool, dy0=bool, scale1=bool, angle1=bool, dy1=bool, dx1=bool)
      ...
      :param bool dx0: enable output: Detected integer offset
      :param bool dy0: enable output: Detected integer offset
      :param bool scale1: enable output: Detected scale
      :param bool angle1: enable output: Detected rotation
      :param bool dy1: enable output: Detected first-order displacement
      :param bool dx1: enable output: Detected first-order displacement
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
   ...
   .. staticmethod:: niftiload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a NIFTI image.
      
      Example:
          out = pyvips.Image.niftiload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: openexrload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load an OpenEXR image.
      
      Example:
          out = pyvips.Image.openexrload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: openslideload(filename, attach_associated=bool, level=int, autocrop=bool, associated=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load file with OpenSlide.
      
      Example:
          out = pyvips.Image.openslideload(filename, attach_associated=bool, level=int, autocrop=bool, associated=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param bool attach_associated: Attach all asssociated images
   ...
   .. staticmethod:: pdfload(filename, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load PDF from file.
      
      Example:
          out = pyvips.Image.pdfload(filename, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: pdfload_buffer(buffer, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load PDF from buffer.
      
      Example:
          out = pyvips.Image.pdfload_buffer(buffer, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: pdfload_source(source, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load PDF from source.
      
      Example:
          out = pyvips.Image.pdfload_source(source, page=int, n=int, dpi=float, scale=float, background=list[float], memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: pngload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load png from file.
      
      Example:
          out = pyvips.Image.pngload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: pngload_buffer(buffer, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load png from buffer.
      
      Example:
          out = pyvips.Image.pngload_buffer(buffer, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: pngload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load png from source.
      
      Example:
          out = pyvips.Image.pngload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: pngsave(filename, compression=int, interlace=bool, profile=str, filter=int, palette=bool, colours=int, Q=int, dither=float, bitdepth=int, strip=bool, background=list[float], page_height=int)
      ...
      :param bool palette: Quantise to 8bpp palette
      :param int colours: Max number of palette colours
      :param int Q: Quantisation quality
      :param float dither: Amount of dithering
      :param int bitdepth: Write as a 1, 2, 4 or 8 bit image
      :param bool strip: Strip all metadata from image
      :param list[float] background: Background value
      :param int page_height: Set page height for multipage save
      :rtype: list[]
   ...
   .. staticmethod:: ppmload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load ppm from file.
      
      Example:
          out = pyvips.Image.ppmload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: ppmload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load ppm base class.
      
      Example:
          out = pyvips.Image.ppmload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: radload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load a Radiance image from a file.
      
      Example:
          out = pyvips.Image.radload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: radload_buffer(buffer, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load rad from buffer.
      
      Example:
          out = pyvips.Image.radload_buffer(buffer, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: radload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load rad from source.
      
      Example:
          out = pyvips.Image.radload_source(source, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: rawload(filename, width, height, bands, offset=long, format=str, interpretation=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load raw data from a file.
      
      Example:
          out = pyvips.Image.rawload(filename, width, height, bands, offset=long, format=str, interpretation=str, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param int width: Image width in pixels
      :param int height: Image height in pixels
      :param int bands: Number of bands in image
      :param long offset: Offset in bytes from start of file
      :param str format: Pixel format in image
      :param str interpretation: Pixel interpretation
      :param bool memory: Force open via memory
      :param str access: Required access pattern for this file
   ...
   .. method:: resize(scale, interpolate=GObject, kernel=str, centre=bool, vscale=float, idx=float, idy=float)
      
      Resize an image.
      
      Example:
          out = in.resize(scale, interpolate=GObject, kernel=str, centre=bool, vscale=float, idx=float, idy=float)
   ...
   .. method:: sequential(trace=bool, tile_height=int, access=str)
      
      Check sequential access.
      
      Example:
          out = in.sequential(trace=bool, tile_height=int, access=str)
      
      :param bool trace: trace pixel requests
      :param int tile_height: Tile height in pixels
      :param str access: Expected access pattern
      :rtype: Image
      :raises Error:
   ...
   .. method:: sharpen(radius=int, sigma=float, x1=float, y2=float, y3=float, m1=float, m2=float)
      ...
      :param int radius: radius of Gaussian
      :param float sigma: Sigma of Gaussian
   ...
   .. staticmethod:: svgload_buffer(buffer, dpi=float, scale=float, unlimited=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      ...
      Example:
          out = pyvips.Image.svgload_buffer(buffer, dpi=float, scale=float, unlimited=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: svgload_source(source, dpi=float, scale=float, unlimited=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load svg from source.
      
      Example:
          out = pyvips.Image.svgload_source(source, dpi=float, scale=float, unlimited=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: switch(tests)
      ...
      :param list[Image] tests: Table of images to test
      :rtype: Image
      :raises Error:
   ...
   .. staticmethod:: system(cmd_format, in=list[Image], out_format=str, in_format=str, out=bool, log=bool)
      ...
      :param bool out: enable output: Output image
      :param bool log: enable output: Command log
      :rtype: list[] or list[Dict[str, mixed]]
      :raises Error:
      
   .. staticmethod:: text(text, font=str, width=int, height=int, align=str, dpi=int, justify=bool, spacing=int, fontfile=str, autofit_dpi=bool)
      
      Make a text image.
      
      Example:
          out = pyvips.Image.text(text, font=str, width=int, height=int, align=str, dpi=int, justify=bool, spacing=int, fontfile=str)
      
      :param str text: Text to render
      :param str font: Font to render with
      :param int width: Maximum image width in pixels
      :param int height: Maximum image height in pixels
      :param str align: Align on the low, centre or high edge
      :param int dpi: DPI to render at
      :param bool justify: Justify lines
      :param int spacing: Line spacing
      :param str fontfile: Load this font file
      :param bool autofit_dpi: enable output: DPI selected by autofit
      :rtype: Image or list[Image, Dict[str, mixed]]
      :raises Error:
      
   .. staticmethod:: thumbnail(filename, width, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      
      Generate thumbnail from file.
      
      Example:
          out = pyvips.Image.thumbnail(filename, width, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      ...
      :param bool no_rotate: Don't use orientation tags to rotate image upright
   ...
   .. staticmethod:: thumbnail_buffer(buffer, width, option_string=str, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      
      Generate thumbnail from buffer.
      
      Example:
          out = pyvips.Image.thumbnail_buffer(buffer, width, option_string=str, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      
      :param str buffer: Buffer to load from
      :param int width: Size to this width
      :param str option_string: Options that are passed on to the underlying loader
      :param int height: Size to this height
      :param str size: Only upsize, only downsize, or both
      :param bool no_rotate: Don't use orientation tags to rotate image upright
      :param str crop: Reduce to fill target rectangle, then crop
   ...
   .. method:: thumbnail_image(width, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      
      Generate thumbnail from image.
      
      Example:
          out = in.thumbnail_image(width, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
   ...
   .. staticmethod:: thumbnail_source(source, width, option_string=str, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
      
      Generate thumbnail from source.
      
      Example:
          out = pyvips.Image.thumbnail_source(source, width, option_string=str, height=int, size=str, no_rotate=bool, crop=str, linear=bool, import_profile=str, export_profile=str, intent=str, auto_rotate=bool)
   ...
   .. staticmethod:: tiffload(filename, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load tiff from file.
      
      Example:
          out = pyvips.Image.tiffload(filename, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param int page: Load this page from the image
      :param int subifd: Select subifd index
      :param int n: Load this many pages
   ...
   .. staticmethod:: tiffload_buffer(buffer, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load tiff from buffer.
      
      Example:
          out = pyvips.Image.tiffload_buffer(buffer, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: tiffload_source(source, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load tiff from source.
      
      Example:
          out = pyvips.Image.tiffload_source(source, page=int, subifd=int, n=int, autorotate=bool, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: tiffsave(filename, compression=str, Q=int, predictor=str, profile=str, tile=bool, tile_width=int, tile_height=int, pyramid=bool, squash=bool, miniswhite=bool, bitdepth=int, resunit=str, xres=float, yres=float, bigtiff=bool, rgbjpeg=bool, properties=bool, region_shrink=str, level=int, subifd=bool, lossless=bool, depth=str, strip=bool, background=list[float], page_height=int)
      
      Save image to tiff file.
      
      Example:
           = in.tiffsave(filename, compression=str, Q=int, predictor=str, profile=str, tile=bool, tile_width=int, tile_height=int, pyramid=bool, squash=bool, miniswhite=bool, bitdepth=int, resunit=str, xres=float, yres=float, bigtiff=bool, rgbjpeg=bool, properties=bool, region_shrink=str, level=int, subifd=bool, lossless=bool, depth=str, strip=bool, background=list[float], page_height=int)
   ...
   .. method:: tiffsave_buffer(compression=str, Q=int, predictor=str, profile=str, tile=bool, tile_width=int, tile_height=int, pyramid=bool, squash=bool, miniswhite=bool, bitdepth=int, resunit=str, xres=float, yres=float, bigtiff=bool, rgbjpeg=bool, properties=bool, region_shrink=str, level=int, subifd=bool, lossless=bool, depth=str, strip=bool, background=list[float], page_height=int)
      
      Save image to tiff buffer.
      
      Example:
          buffer = in.tiffsave_buffer(compression=str, Q=int, predictor=str, profile=str, tile=bool, tile_width=int, tile_height=int, pyramid=bool, squash=bool, miniswhite=bool, bitdepth=int, resunit=str, xres=float, yres=float, bigtiff=bool, rgbjpeg=bool, properties=bool, region_shrink=str, level=int, subifd=bool, lossless=bool, depth=str, strip=bool, background=list[float], page_height=int)
   ...
   .. method:: transpose3d(page_height=int)
      ...
      :param int page_height: Height of each input page
      :rtype: Image
      :raises Error:
   ...
   .. method:: unpremultiply(max_alpha=float, alpha_band=int)
      ...
      :param float max_alpha: Maximum value of alpha channel
      :param int alpha_band: Unpremultiply with this alpha
      :rtype: Image
      :raises Error:
      
   .. staticmethod:: vipsload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load vips from file.
      
      Example:
          out = pyvips.Image.vipsload(filename, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: webpload(filename, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load webp from file.
      
      Example:
          out = pyvips.Image.webpload(filename, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
      
      :param str filename: Filename to load from
      :param int page: Load this page from the file
      :param int n: Load this many pages
      :param float scale: Scale factor on load
      :param int shrink: Shrink factor on load
      :param bool memory: Force open via memory
      :param str access: Required access pattern for this file
      :param bool sequential: Sequential read only
   ...
   .. staticmethod:: webpload_buffer(buffer, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load webp from buffer.
      
      Example:
          out = pyvips.Image.webpload_buffer(buffer, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. staticmethod:: webpload_source(source, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool, flags=bool)
      
      Load webp from source.
      
      Example:
          out = pyvips.Image.webpload_source(source, page=int, n=int, scale=float, shrink=int, memory=bool, access=str, sequential=bool, fail=bool, disc=bool)
   ...
   .. method:: webpsave(filename, Q=int, lossless=bool, preset=str, smart_subsample=bool, near_lossless=bool, alpha_q=int, min_size=bool, kmin=int, kmax=int, reduction_effort=int, strip=bool, background=list[float], page_height=int)
      ...
      :param bool min_size: Optimise for minium size
